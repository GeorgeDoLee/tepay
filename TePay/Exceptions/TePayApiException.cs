...
/// <summary>
/// Represents an exception that occurs when the TBC Payment API returns an error response.
/// </summary>
internal class TePayApiException : Exception
{
    /// <summary>
    ...
    public TePayApiException(HttpStatusCode statusCode, ErrorResponse errorResponse)
